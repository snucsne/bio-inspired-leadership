...
public class SimulatorEvolution
{
    ...
    public static void main(String[] args){
        DestinationRunCounts drc = new DestinationRunCounts("cfg/sim/destinations/destinations-split-10-dis-150.0-ang-72.00-per-0.500-seed-1.dat", 1);
        DestinationRunCounts[] drcs = {drc};
        EvolutionInputParameters input = new EvolutionInputParameters(0.006f, 0.01f, 2, 2.3f, 0.009f, -0.009f, drcs);
    ...
    /**
     * Used for running evolutionary computation on the Sueur model simulator given an EvolutionInputParameters object
     *
     * @param p The input parameters for this evolution
     * @param propertiesFilename If null, "cfg/sim/discrete/sim-properties.parameters" will be used.
     * @return
     */
    public static EvolutionOutputFitness runEvolutionFromInputParameters(EvolutionInputParameters p, String propertiesFilename){
        ...
        for(int i = 0; i < p.destinationRunCounts.length; i++){
            ...
            _simulationProperties.setProperty( "destinations-file", p.destinationRunCounts[i].destinationFilename );
        ...
        //return the mean percentages of all the runs as the final EvolutionOutputFitness
        return new EvolutionOutputFitness( totalTime / totalRuns, totalSurvive / totalRuns, totalSuccess / totalRuns );
    }
    
    /**
     * Used for running evolutionary computation on the Sueur model simulator from a json file
     *
    ...
    public static void inputParametersToJson(EvolutionInputParameters P, String filename){
        //open a json writer
        String json = null;
        try{
