...
import edu.snu.leader.discrete.behavior.AdaptivePersonalityTrait;
import edu.snu.leader.discrete.behavior.MovementBehavior;
import edu.snu.leader.discrete.behavior.PersonalityTrait;
...
public class SueurPersonalitySimpleAngularAgentBuilder implements AgentBuilder
{
    ...
    public List<Agent> build()
    {
        ...
        {
            // set the personality trait to be adaptive
            PersonalityTrait pt = new AdaptivePersonalityTrait();
            agents.add( new Agent( pt, temp ) );
        }
