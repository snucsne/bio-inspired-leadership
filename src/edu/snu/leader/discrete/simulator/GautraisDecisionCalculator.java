...
/**
 * GautraisDecisionCalculator The default decision calculator using the Gautrais
 * model
 * 
 * @author Tim Solum
 ...
 */
@Deprecated
// use instead GautraisDefaultDecisionCalculator
public class GautraisDecisionCalculator implements
