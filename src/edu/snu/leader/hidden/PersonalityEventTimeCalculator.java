...
//    private static final float _BETA = (float) Math.pow( 10.0f, (1.0f / _ALPHA) );
     ...
     * @see edu.snu.leader.hidden.AbstractEventTimeCalculator#initialize(edu.snu.leader.hidden.SimulationState)
     */
    @Override
     ...
     * @see edu.snu.leader.hidden.EventTimeCalculator#calculateInitiationTime(edu.snu.leader.hidden.SpatialIndividual)
     */
    @Override
...
//                    + "]" );
     ...
     * @see edu.snu.leader.hidden.EventTimeCalculator#calculateFollowTime(edu.snu.leader.hidden.SpatialIndividual, edu.snu.leader.hidden.SpatialIndividual, int, int)
     */
    @Override
...
//                    + "]" );
    ...
    * @return The cancellation time
     * @see edu.snu.leader.hidden.EventTimeCalculator#calculateCancelTime(edu.snu.leader.hidden.SpatialIndividual, int)
     */
    @Override
...
//                    + "]" );
     ...
     * @see edu.snu.leader.hidden.AbstractEventTimeCalculator#describeInitiation()
     */
    @Override
     ...
     * @see edu.snu.leader.hidden.AbstractEventTimeCalculator#describeFollow()
     */
    @Override
     ...
     * @see edu.snu.leader.hidden.AbstractEventTimeCalculator#describeCancellation()
     */
    @Override
