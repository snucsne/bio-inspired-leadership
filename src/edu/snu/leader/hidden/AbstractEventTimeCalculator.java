...
public abstract class AbstractEventTimeCalculator implements EventTimeCalculator
{
     ...
     * @see edu.snu.leader.hidden.EventTimeCalculator#initialize(edu.snu.leader.hidden.SimulationState)
     */
    @Override
     ...
     * @see edu.snu.leader.hidden.EventTimeCalculator#describeInitiation()
     */
    @Override
     ...
     * @see edu.snu.leader.hidden.EventTimeCalculator#describeFollow()
     */
    @Override
     ...
     * @see edu.snu.leader.hidden.EventTimeCalculator#describeCancellation()
     */
    @Override
