...
TRAIT_FILE_PREFIX=cfg/sim/locations/metric/personality-traits/personality-traits-indcount
...
do
    ...
    do
        ...
        TRAITS_FILE="$TRAIT_FILE_PREFIX-$FORMATTED_IND_COUNT-map-$FORMATTED_MAP.dat"
        ...
        do
            ...
            java -cp $CLASSPATH \
                    ...
                    -Dpersonality-traits-file=$TRAITS_FILE \
