...
DATADIR="data/simple-dev-with-$OTHERPART-predation-$THISPART-alt-and-ind"
mkdir $DATADIR

./evolve.sh \
    --params evolve/experiments/simple-development-with-other-and-alt-and-indicator.parameters \
    --logprefix log \
