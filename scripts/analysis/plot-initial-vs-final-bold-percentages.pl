...
# -------------------------------------------------------------------
# Plot it
my @colors = ( "#771155", "#9C0A2E", "#332288", "#117733", "#999933" );
...
print INPUT "plot( datapositions, meanvalues, type=\"l\", yaxt='n', xaxt='n',\n",
            ...
            "    ylim=c($yMin,$yMax), xlim=c($yMin,$yMax), col=\"",$colors[0],"\",\n",
...
print INPUT "title(ylab=\"Final Bold\", mgp = c(3.25, 1, 0), cex=1.5 )\n";

print INPUT "percentlabels <- sprintf( \"%3d%%\", c(10, 30, 50, 70, 90) )\n";

print INPUT "axis( 1, las=1, at=c(0.1,0.3,0.5,0.7,0.9), labels=percentlabels)\n";
print INPUT "axis( 2, las=2, at=c(0.1,0.3,0.5,0.7,0.9), labels=percentlabels)\n";
print INPUT "axis( 4, las=2, at=c(0.1,0.3,0.5,0.7,0.9), labels=percentlabels)\n";
