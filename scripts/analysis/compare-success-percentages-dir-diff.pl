...
#    my $boxColor = "orange";
    ...
    print INPUT "par(mgp=c(3,1,0))\n";
    my $index = 0;
    my @colors = ( "#882255", "#332288", "#117733", "#999933", "#AA4499", "#88CCEE", "#DDCC77", "#CC6677", "#44AA99", "#000000" );
    ...
    foreach my $indCount (@indCounts)
    {
        ...
        foreach my $dataSet (@dataSets)
        {
            ...
            $dataFrameStr .= "$id=$id, ";
            $meanStr .= "median($id), ";
            $labelStr .= "expression(paste(\"".($dataSet*360)."\",degree)), ";
    ...
    foreach my $indCount (@indCounts)
    {
        ...
        print INPUT "$cmd( datasets, ",$meansIDStrings[$index],", type=\"o\", \n",
                    "    lwd=2, pch=",$plotSymbols[$index],",\n",
                    "    ",$misc," col=\"",$colors[$index],"\", yaxt='n', xaxt='n' )\n";
