...
# Files
OUTPUT_DATA_FILE=$DATA_DIR/analysis/mimics-vs-success-correlation.dat
OUTPUT_EPS_FILE=$DATA_DIR/figures/mimics-vs-success-correlation.eps
...
do
    ...
    CORRELATION=`grep -A 1 "Correlation: mimics vs. success" \
