...
# Files
OUTPUT_DATA_FILE=$DATA_DIR/analysis/eig-vs-success-correlation-spearman-p-values.dat
...
do
    ...
    CORRELATION=`grep -A 18 "Correlation: eigenvector centrality vs. success" \
